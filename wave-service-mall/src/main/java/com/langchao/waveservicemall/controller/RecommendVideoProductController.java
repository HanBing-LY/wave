...
@RestController
@RequestMapping("recommend/video/product")
public class RecommendVideoProductController  extends BaseController {
    @Autowired
    private RecommendVideoProductService recommendVideoProductService;
    @Autowired
     ...
     */
    @PostMapping
    public JsonResult add(@RequestBody RecommendVideoProduct recommendVideoProduct){
        ...
        recommendVideoProductService.save(recommendVideoProduct);
        return success();
    }
    ...
    public JsonResult delpl(@RequestParam("checkIds") String checkIds) {
        ...
        try{
            recommendVideoProductService.deleteByIds(checkIds);
        }catch (Exception e){
     ...
     */
    @PutMapping("/update")
    public JsonResult update(@RequestBody RecommendVideoProduct recommendVideoProduct){
        recommendVideoProductService.update(recommendVideoProduct);
        return success();
    }
    ...
    public JsonResult detail(@PathVariable Integer id) {
        return success(recommendVideoProductService.findById(id));
    }
    ...
    public JsonResult list(
        ...
        return success(recommendVideoProductService.findManagerList(page, size));
    }
