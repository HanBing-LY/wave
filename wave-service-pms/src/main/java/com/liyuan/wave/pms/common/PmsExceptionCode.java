 ...
 */
@ToString
public enum PmsExceptionCode implements ExceptionResult {

    PARENT_NOT_EXIST(false,90001,"该父节点不存在,请重选！"),
    PLEASE_CHO0SE_TO_DELETE(false,90002,"请选择需要删除的分类！"),
    PRODUCT_SKU_NOT_EXIST(false,90003,"sku产品不存在！"),
    PRODUCT_IS_SHELVES(false,90004,"商品已下架！")
    ...
    PmsExceptionCode(boolean success, int code, String message){
